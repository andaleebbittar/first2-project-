...
const control = require("../controllers/productivity.controller");
const { type } = require("../validation/typeValidation");
const { schema } = require("../schema/productivity.schema");
...
router.get("/chart",authMiddleware,control.getChart)
